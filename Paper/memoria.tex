...
\begin{itemize}
    ...
    \begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth]{adasAlcolock.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{saeLevels.jpg}
	\caption{Niveles de autonomía según el estándar SAE J3016 \cite{sae}.}
	\label{fig:imagen19}
\end{figure}
