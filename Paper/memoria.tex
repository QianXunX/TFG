...
\begin{itemize}
    ...
    \begin{figure}[H]
		...
		\caption{Funcionamiento del sistema EDR. Fuente: \cite{adasObligatorios}}
		\label{fig:imagen14}
	\end{figure}
    ...
    \begin{figure}[H]
		...
		\caption{Funcionamiento del sistema LDW. Fuente: \cite{adasObligatorios}}
		\label{fig:imagen15}
	\end{figure}
    ...
    \begin{figure}[H]
		...
		\caption{Funcionamiento del sistema Alcolock. Fuente: \cite{adasObligatorios}}
		\label{fig:imagen17}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{Funcionamiento del sistema de Alerta de cinturón en las plazas traseras. Fuente: \cite{adasObligatorios}}
		\label{fig:imagen18}
	\end{figure}
...
\begin{table}[H]
	\ttabbox[\FBwidth]
	{\caption{Tabla de comparación de datasets}}
	{
	  \begin{tabular}{|P{3cm}|P{3cm}|P{3cm}|c|}
		\hline
		{\cellcolor{gray}\textbf{Dataset}} & {\cellcolor{gray}\textbf{Cantidad}} & {\cellcolor{gray}\textbf{Resolución}} & {\cellcolor{gray}\textbf{Estado}} \\
		\hline
...
\begin{table}[H]
	\ttabbox[\FBwidth]
	{\caption{Tabla de comparación de diferentes datasets}}
	{
